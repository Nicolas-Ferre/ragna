...
pub fn use_vectors() {
    ...
    assert_eq!(app.read(*gpu::MISALIGNED), Some(i32x3 { x: 2, y: 3, z: 4 }));
...
#[ragna::gpu]
mod gpu {
    use ragna::{i32x2, Cpu, I32x2, I32x3, I32};
    ...
    pub(super) static MISALIGNED: I32x3 = I32x3::new(2, 3, 4);
